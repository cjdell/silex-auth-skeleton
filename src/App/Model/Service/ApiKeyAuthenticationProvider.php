...
use App\Model\Service\ApiKeyToken;
use App\Model\Service\ApiKeyUserProviderInterface;
use App\Model\Service\SaltLessPasswordEncoderInterface;
...
class ApiKeyAuthenticationProvider implements AuthenticationProviderInterface
{
    ...
    public function authenticate(TokenInterface $token)
    {
        ...
        $token = new ApiKeyToken($token->getCredentials(), explode(',', $user->getRoles()));
        $token->setUser($user);
